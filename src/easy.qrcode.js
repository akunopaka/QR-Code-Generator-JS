...
CanvasRenderingContext2D.prototype.roundRect = function (x, y, w, h, radii, fillColor) {
	...
	// Begin a path
	this.beginPath();
	// Calculate the radii for each corner
	...
	this.arcTo(x + w, y, x + w, y + topRightRadius, topRightRadius);
	// Draw the right line
	this.lineTo(x + w, y + h - bottomRightRadius);
	// Draw the bottom-right corner
	this.arcTo(x + w, y + h, x + w - bottomRightRadius, y + h, bottomRightRadius);
	// Draw the bottom line
	this.lineTo(x + bottomLeftRadius, y + h);
	// Draw the bottom-left corner
	this.arcTo(x, y + h, x, y + h - bottomLeftRadius, bottomLeftRadius);
	// Draw the left line
